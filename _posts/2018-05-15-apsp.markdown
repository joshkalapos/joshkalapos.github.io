...
A final project for [15-418: Parallel Computer Architecture and Programming]

Jared Moore (jmoore1) and Josh Kalapos (jkalapos)

View our project on github [here]

View [Checkpoint 1](/assets/jkalapos_jmoore1_checkpoint_1.pdf)

View [Checkpoint 2](/assets/jkalapos_jmoore1_checkpoint_2.pdf)
...
![Figure 1: Blocked Floyd Warshall](/assets/img/apsp/APSP_Fig1.png) | ![Figure 2: Visualizing blocking on the matrix W](/assets/img/apsp/APSP_Fig2.png) | ![Figure 3: Parallel Blocked Floyd-Warshall](/assets/img/apsp/APSP_Fig3.png)
...
[15-418: Parallel Computer Architecture and Programming]: http://www.cs.cmu.edu/~418/
[here]: https://github.com/moorejs/APSP-in-parallel
